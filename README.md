...
The [Maker Guide](/documentation/Product_Manual_Squeeze_Grip_Switch.pdf)  contains all the necessary information to build this device, including tool lists, assembly instructions, and testing.
...
| Changelog            | 1.0     | [Squeeze_Grip_Switch_Change_Log](/documentation/CHANGES.txt)     |
...
Source Location: <https://github.com/Engineering-Good/T4G-Squeeze-Grip-Switch>
